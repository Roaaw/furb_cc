...
public class Uni5Exe24 {
    ...
    private DecimalFormat cm = new DecimalFormat("0");
    private boolean exit = true;
    private char comfirma;
    private float limiteDiario = 150;
    private float pescou = 0;
    private float peso = 0;
    private float pegos = 0;
    private float l = 0;
    private float w = 0;
    private float a = 0.0278f;
    private float b = 2.79f;
    private float v = 0;
